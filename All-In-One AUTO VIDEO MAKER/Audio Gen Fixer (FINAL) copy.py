...
def convert_audio_sample_rate(input_file, output_file, target_sample_rate=44100):
    ...
    ffmpeg_command = [
        ...
        '-c:a', 'libfaac',  # Use libmp3lame encoder
        output_file
    ]
...
def main():
    original_audio_path = r"E:\Python_Practice\AI_AUTO_VIDEO_MAKER\gen_audio\[Complete]-Thich_Nhat_Hanh-I-would-not-look-upon.mp3"
    ...
    original_audio_volume = 4.0  # Default 1 = 100%
    merged_audio_volume = 0.15  # Default -0.50 = 50%
