...
def main():
    ...
    audio_input_folder = r"E:\Python_Practice\FFMPEG_VIDEO_MAKER\output\converted_finished"
    output_folder = "output"
    finished_videos_folder = os.path.join(output_folder, "Finished Videos")  # Create "Finished Videos" folder
    target_resolution = (1920, 1080)
    target_fps = 24

    # Settings for audio volumes
    original_audio_volume = 1.0  # Default 100%
    merged_audio_volume = 0.50  # Default 50%
