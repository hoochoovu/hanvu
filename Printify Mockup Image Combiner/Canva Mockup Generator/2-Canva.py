...
OFFSET_X = 1425 #Higher number moves left, Lower Number moves right
OFFSET_Y = 967 #Higher number moves down, Lower Number moves up
...
if __name__ == "__main__":
    bg_folder = r"E:\Python_Practice\Printify Mockup Image Combiner\Background Templates\Canva\2-Canva"
