...
OFFSET_X = 1315  # Higher number moves left, Lower number moves right
OFFSET_Y = 1024  # Higher number moves down, Lower number moves up

# Cropping size (pixels) for foreground image
CROP_LEFT = 85
CROP_RIGHT = 85
CROP_TOP = 0   # New variable for cropping from the top
CROP_BOTTOM = 0  # New variable for cropping from the bottom
...
if __name__ == "__main__":
    bg_folder = r"E:\Python_Practice\Printify Mockup Image Combiner\Background Templates\Canva\5-Canva"
