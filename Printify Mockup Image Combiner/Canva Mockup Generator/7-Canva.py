...
OFFSET_X = 1030  # Higher number moves left, Lower number moves right
OFFSET_Y = 656  # Higher number moves down, Lower number moves up
...
if __name__ == "__main__":
    bg_folder = r"E:\Python_Practice\Printify Mockup Image Combiner\Background Templates\Canva\7-Canva"
