...
OFFSET_X = 1554  # Higher number moves left, Lower number moves right
OFFSET_Y = 637  # Higher number moves down, Lower number moves up
...
if __name__ == "__main__":
    bg_folder = r"E:\Python_Practice\Printify Mockup Image Combiner\Background Templates\Canva\8-Canva"
    fg_folder = r"E:\Python_Practice\Printify Mockup Image Combiner\Canva Mockup Generator\canva_fg\3x4"
