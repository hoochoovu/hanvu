...
def overlay_images(bg_folder, fg_folder, output_folder, output_format="jpg", fg_opacity=100):
    ...
    dst_top_left = (1393, 1008)
    dst_top_right = (3365, 906)
    dst_bottom_right = (3198, 2886)
    dst_bottom_left = (1223, 2819)
...
if __name__ == "__main__":
    bg_folder = r"E:\Python_Practice\Printify Mockup Image Combiner\Perspective Mockup Generator\bg\h2"
