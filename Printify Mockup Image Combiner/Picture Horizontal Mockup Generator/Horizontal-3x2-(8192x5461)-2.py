...
OFFSET_X = 1263 #Lower goes right
OFFSET_Y = 145 #Lower goes up
...
if __name__ == "__main__":
    bg_folder = r"E:\Python_Practice\Printify Mockup Image Combiner\Picture Horizontal Mockup Generator\bg\hori5"
