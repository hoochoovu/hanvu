...
if __name__ == "__main__":
    bg_folder = r"I:\IntelDrive Dataset\Samurai-Monk-Roman 11 Min Videos"
    fg_folder = r"E:\Dataset\All Audio Quotes\Video Clips (Full Letters)\Horizontal\Golden 2s Added"
    title_folder = r"E:\Dataset\All Authors\44.1khz\Horizontal (44.1khz)"
    ...
    duration = 23795  # Options: duration in seconds (e.g., 59, 119, 599, 30 * 60, 60 * 60, 23795 ,28799, 32948, 40270)
    ...
    altbg1_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\Random" #\Random\Exercise for subfolder only
    altbg2_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\Random\Stoic" #Random/Stoic folder includes lots of 2, 10, 30 and 60 min stoic videos.
    altbg_category = "Random"  # Replace with "Exercise", "Hiking", "Ocean", "God", "Monk", "Rock", "Time", "Stoic", "Random", or None
    #Only 10m videos can choose a category. If video is less than 599, it will always be randomized background because the 1 min folder contains all types.
