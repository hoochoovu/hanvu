    ...
    try:
        ...
        if len(bg_paths) > 1:
            ...
            command = [
                ...
                "-c:v", "copy", "-fflags", "+genpts", "-y", bg_concat_path
            ]
            subprocess.run(command, check=True)
        else:
        ...
        command = [
            ...
            "-c:v", "h264_nvenc", "-preset", "slow", "-b:v", bitrate,
            "-c:a", "aac", "-b:a", "192k",
...
if __name__ == "__main__":
    ...
    duration = 30 * 60  # Options: duration in seconds (e.g., 59, 119, 599, 30 * 60, 60 * 60, 23795 ,28799, 32948, 40270)
    iterations = 15  # Number of iterations to generate
    ...
    altbg2_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\Smoke"
