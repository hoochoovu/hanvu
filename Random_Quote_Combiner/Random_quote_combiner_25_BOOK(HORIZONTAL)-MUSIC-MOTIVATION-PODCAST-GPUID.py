...
def create_final_video_sequence(bg_folder, fg_folder, title_folder, author_folder, stoistica_folder, book_folder, motivation_folder, output_folder, duration, iterations, quality, bg_music, bg_music_volume, final_audio_volume, altbg1_folder, altbg2_folder, altbg3_folder, altbg4_folder, altbg5_folder):
...
if __name__ == "__main__":
    ...
    title_folder = r"E:\Dataset\All Notebook Audio\Podcast Clips Blanks\Horizontal"
    author_folder = r"E:\Dataset\All Authors\44.1khz\Horizontal (44.1khz)"
    ...
    duration = 60 * 60  # Options: duration in seconds (e.g., 59, 119, 599, 30 * 60, 60 * 60, 23795 ,28799, 32948, 40270)
    ...
    motivation_folder = r"E:\Dataset\All Authors\44.1khz\Horizontal (44.1khz)"
    altbg1_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\2 Minute\Stoic"#\Random\Exercise for subfolder only
    altbg2_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\Random\Ocean, Beach, Sand"
    altbg3_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\Random\Gladiator 15s"
    altbg4_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\Smoke"
    altbg5_folder = r"E:\Dataset\All Video BG\Watermarked\Horizontal\Random\PEXEL PIXABAY (Exclude Beach Sand Ocean)"
    ...
    create_final_video_sequence(
        ...
        altbg1_folder, altbg2_folder, altbg3_folder, altbg4_folder, altbg5_folder
    )