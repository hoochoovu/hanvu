...
if __name__ == "__main__":
    folder_path = r"E:\Dataset\PEXELS\ZZLinks"  # Folder with .txt files
    main_output_folder = r"E:\Dataset\PEXELS\SCRAPE OUTPUT"  # Replace with your desired main output folder
