...
def process_videos(fg_folder, bg_folder, output_folder, zoom=1.0, codec="h264", crf=23, bitrate="4M", speed="fast"):
    """
...
if __name__ == "__main__":
    fg_folder = r"E:\Python_Practice\Transparency_Test\fg"
    bg_folder = r"E:\Dataset\All Samurai Photos\1 min v1\2nd"
    output_folder = r"E:\Python_Practice\Transparency_Test\output"
    ...
    # Process videos
    process_videos(fg_folder, bg_folder, output_folder, zoom, codec, crf, bitrate, speed)
