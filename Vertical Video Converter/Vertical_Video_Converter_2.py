...
for filename in os.listdir(input_folder):
    if filename.endswith('.mp4'):
        ...
        # Scale and pad filter to maintain the 1080x1920 resolution
        scale_filter = f'scale={int(1080 * scaling_factor)}:-1'
        pad_filter = 'pad=1080:1920:(ow-iw)/2:(oh-ih)/2'
        ...
        command = [
            ...
            '-i', input_path,
            '-vf', f'{scale_filter},{pad_filter}',  # Apply scaling and padding
