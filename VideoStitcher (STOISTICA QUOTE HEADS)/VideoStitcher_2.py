...
def merge_videos(input_folder, output_folder, target_duration, target_resolution, target_fps=24):
    """
...
def main():
    ...
    target_resolution = (1080, 1080)  # Desired resolution
    ...
    merge_videos(video_input_folder, output_folder, target_duration, target_resolution)
