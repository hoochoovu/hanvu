...
def process_videos(input_folder, output_folder, encoder='h264', iterations=1, duration=60, crf=30, bitrate=None, speed=4, gpu_id=0):
...
if __name__ == "__main__":
    ...
    process_videos(input_folder, output_folder, encoder, iterations, duration=60, crf=crf, bitrate=bitrate, speed=speed, gpu_id=gpu_id)
